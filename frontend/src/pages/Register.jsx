...
export default function Register() {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center md:justify-start bg-gradient-to-br from-gray-900 via-black to-gray-800 p-4 sm:p-5">
      ...
      <motion.div 
        className="absolute w-3/4 mt-0 mb-40 max-w-md z-50 ml-200 hidden lg:block"
      ...
      <motion.div 
        className="absolute z-10 w-full max-w-lg md:left-20 md:mt-7 md:transform md:translate-y-[-2%]"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        transition={{
          delay: 0.7,
